...
class Evaluation(Module):
    ...
    def calculate_results(detected_landslide_ids, eval_df, landslide_ids, results) -> tuple:
        ...
        recall = tp / len(landslide_ids)  #138
        #print(len(landslide_ids))
    ...
    def load_inventory(self, dim: dict = None):
        ...
        return inventory[(inventory.date >= self._date_start) & (inventory.date < self._date_end)]     #LP:  inventory is calculated from Max/Min Long/Lat --> used to compute landslide_dim --> Flase Negative
